...
export function getSlackInitials(name: string): string {
  return name
    .split(' ')
    .map((w) => w[0])
    .join('')
...
function getMessageInitials(message: SlackMessageData): string {
  return message.avatarInitials || getSlackInitials(message.sender)
}

export function getSlackAvatarColor(name: string): string {
        ...
        >
          ...
          <div
            style={{
              ...
              height: '24px',
              borderRadius: '4px',
              backgroundColor: getSlackAvatarColor(message.sender),
              display: 'flex',
              alignItems: 'center',
