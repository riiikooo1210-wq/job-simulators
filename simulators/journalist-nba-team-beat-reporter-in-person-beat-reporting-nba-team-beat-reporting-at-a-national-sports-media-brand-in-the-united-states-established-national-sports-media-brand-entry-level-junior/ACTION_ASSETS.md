# Action asset prompts — Journalist
_Slug: `journalist-nba-team-beat-reporter-in-person-beat-reporting-nba-team-beat-reporting-at-a-national-sports-media-brand-in-the-united-states-established-national-sports-media-brand-entry-level-junior` · 1 physical/action scene(s)_
...
## warmup_observation
Scene title: Warmup Observation at Media Row
Simulated action: Inspect in-arena source surfaces and document a caveated observation before interviews.
...
### public/action-assets/warmup_observation/injury-email-closeup.png

COPY THIS WHOLE ASSET PROMPT.

Asset-specific subject:
Readable closeup of a laptop email from team PR. Text should include: "Malik Reed - Available. No minutes limit listed." Keep it realistic, like an email open on a reporter laptop at media row, not a printed note.
...
### public/action-assets/warmup_observation/reed-warmup-closeup.png

COPY THIS WHOLE ASSET PROMPT.

Asset-specific subject:
Closeup from media row of Malik Reed doing a hard lateral cut during warmups. Show athletic movement and a neutral facial expression, with no answer captions, checkmarks, conclusion labels, or documentation text.
...
Asset-specific subject:
Closeup of Malik Reed briefly speaking with a trainer near the baseline during warmups. Show a routine check-in posture, phones and media nearby, with no answer captions, checkmarks, conclusion labels, or documentation text.
...
### public/action-assets/warmup_observation/rumor-feed-closeup.png

COPY THIS WHOLE ASSET PROMPT.

Asset-specific subject:
Readable phone closeup showing fan-account posts speculating about a Malik Reed trade. Make usernames look fictional and unofficial. Include visible uncertainty such as "hearing chatter" and "unconfirmed" but no verification badges.
