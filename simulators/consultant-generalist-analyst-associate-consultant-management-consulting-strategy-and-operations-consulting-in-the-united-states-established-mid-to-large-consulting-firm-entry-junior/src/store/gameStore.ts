...
const persistKey =
  typeof STORE_PERSIST_KEY !== 'undefined' && STORE_PERSIST_KEY
    ? STORE_PERSIST_KEY
    : 'consultant-generalist-analyst-associate-consultant-management-consulting-strategy-and-operations-consulting-in-the-united-states-established-mid-to-large-consulting-firm-entry-junior-simulator-storage-v2'
