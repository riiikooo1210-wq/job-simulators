...
export default function StructuredEntryScene({ node }: Props) {
  ...
  const presentation = def.presentation
    ?? (node.workSurface?.kind === 'spreadsheet_workbook' ? 'spreadsheet'
      ...
      : 'cards')
  const verticalRows = presentation === 'vertical_rows'
          ...
          {items.map((_item, idx) => (
            <section
              ...
              style={{
                border: '1px solid #CDBF94',
                background: '#FBF7EA',
                boxShadow: '0 1px 0 rgba(30, 30, 26, 0.04)',
              }}
            >
              <div
                style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                {def.fields.map((field, fieldIdx) => (
                  <div
                    key={field.key}
                    style={{
                      display: 'grid',
                      gridTemplateColumns: 'minmax(116px, 0.22fr) minmax(0, 1fr)',
                      borderTop: fieldIdx ? '1px solid #E4D8B9' : 0,
                      minWidth: 0,
                    }}
                  >
                    <label
                    ...
                    <div style={{ padding: '0.5rem', minWidth: 0 }}>
