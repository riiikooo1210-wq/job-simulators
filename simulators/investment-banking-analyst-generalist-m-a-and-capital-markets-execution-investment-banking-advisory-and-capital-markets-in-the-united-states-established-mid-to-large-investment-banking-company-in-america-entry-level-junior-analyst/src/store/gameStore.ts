...
const persistKey =
  typeof STORE_PERSIST_KEY !== 'undefined' && STORE_PERSIST_KEY
    ? STORE_PERSIST_KEY
    : 'investment-banking-analyst-generalist-m-a-and-capital-markets-execution-investment-banking-advisory-and-capital-markets-in-the-united-states-established-mid-to-large-investment-banking-company-in-america-entry-level-junior-analyst-simulator-storage'
