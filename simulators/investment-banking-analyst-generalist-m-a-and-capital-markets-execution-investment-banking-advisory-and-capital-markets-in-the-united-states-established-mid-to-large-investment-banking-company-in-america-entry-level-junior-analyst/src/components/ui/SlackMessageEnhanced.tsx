...
export default function SlackMessageEnhanced({ message, delay = 0, initialExpanded = false, showUnreadDot = true }: Props) {
  ...
  const previewContent = message.content.replace(/\{\{([^}]+)\}\}/g, '$1')
      ...
      {!expanded && (
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0, display: 'flex', alignItems: 'baseline', gap: '0.375rem' }}>
            ...
            <span style={{ fontWeight: 400, fontSize: '0.6875rem', color: '#8A8176', flexShrink: 0 }}>
              {message.role}
            </span>
            <span
              style={{
            ...
            >
              {truncate(previewContent.replace(/\n/g, ' '), 80)}
            </span>
          </div>
          {/* Timestamp */}
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
                  ...
                  <span style={{ fontWeight: 400, fontSize: '0.75rem', color: '#8A8176' }}>
                    {message.role}
                  </span>
