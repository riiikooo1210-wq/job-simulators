# Image prompts — game-designer-gameplay-systems-and-level-experience-design-nintendo-like-fictional-family-friendly-aaa-console-gameplay-studio-large-aaa-enterprise-studio-mid-level
_Slug: `game-designer-gameplay-systems-and-level-experience-design-nintendo-like-fictional-family-friendly-aaa-console-gameplay-studio-large-aaa-enterprise-studio-mid-level` · 17 scenes_
...
A bright, polished AAA game studio design area with warm wood desks, concept art of cute forest guardians on the walls, a console controller, design notebooks, and a large screen showing a whimsical green platforming level. No real company logos.
...
## morning_briefing
Filename: public/scenes/morning_briefing.png
...
## scope_consequence_clarity
Filename: public/scenes/scope_consequence_clarity.png

COPY THIS WHOLE PROMPT.

Scene-specific subject:
First-person view at a game studio desk just after a Slack scope decision. Show a laptop with generic unreadable chat shapes, a controller, sticky notes, and a small sketch of the Wind Bud level nearby. Do not include readable Slack message text; the simulator renders the thread separately.
...
## scope_consequence_enemy
Filename: public/scenes/scope_consequence_enemy.png

COPY THIS WHOLE PROMPT.

Scene-specific subject:
First-person view at a game studio desk during a scope-risk moment. Show a laptop with generic unreadable chat bubbles, an engineer's code/debug window hinted in the background, a controller, and a design notebook. Do not include readable Slack message text; the simulator renders the thread separately.
...
## scope_consequence_secret
Filename: public/scenes/scope_consequence_secret.png

COPY THIS WHOLE PROMPT.

Scene-specific subject:
First-person view at a game studio desk after a producer pushes a reward-route idea to backlog. Show a laptop with generic unreadable chat shapes, a tidy milestone checklist, sticky notes, and a controller. Do not include readable Slack message text; the simulator renders the thread separately.
...
## playtest_packet
Filename: public/scenes/playtest_packet.png

COPY THIS WHOLE PROMPT.

Scene-specific subject:
First-person view in a game studio QA/playtest corner. A cream laptop shows generic unreadable rows and charts, a controller rests beside a notebook of playtest observations, and a monitor in the background shows a whimsical forest platforming room. Do not include exact metric values or issue text; the simulator renders those in coded UI.
...
## design_review
Filename: public/scenes/design_review.png

COPY THIS WHOLE PROMPT.

Scene-specific subject:
First-person view in a bright AAA game studio huddle room beside a playtest lab. Maya Chen, a calm lead gameplay designer in her late 30s with short dark hair and a notebook, sits across the table with a controller and printed level flow nearby. Warm professional illustration, no real company logos.
...
Scene-specific subject:
A calm end-of-day game studio desk with a controller, notebook, and completed design packet on a warm cream laptop. No assessment scores visible.
...
Scene-specific subject:
A calm assessment moment represented by a warm game studio desk with the completed design packet closed, a controller, and soft studio background. No scores, charts, grading text, or report cards visible.
...
Scene-specific subject:
A polished final wrap-up scene at a game studio desk with a laptop showing an abstract report layout with unreadable blocks, completed notes, a controller, and concept art in the background. No exact scores or readable assessment text in the image.
