...
export default function EmailCompose({
  ...
  const HeaderRow = ({ label, val }: { label: string; val: string }) => (
    <div style={{ display: 'flex', borderBottom: '1px solid #E5E7EB', padding: compact ? '0.2rem 0.4rem' : '0.28rem 0.5rem', fontSize: '0.8125rem' }}>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', minHeight: 0, backgroundColor: windowCream }}>
      ...
      <div
        style={{
          padding: compact ? '0.25rem 0.3rem 0.3rem' : '0.4rem',
        ...
        >
          <textarea
            ...
            style={{
              ...
              padding: compact ? '0.4rem 0.45rem' : '0.5rem',
              fontSize: '0.875rem',
              lineHeight: 1.6,
          ...
          <div
            style={{
              ...
              gap: '0.75rem',
              padding: compact ? '0.2rem 0.35rem' : '0.3rem 0.5rem',
