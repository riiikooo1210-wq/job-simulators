...
export type StructuredEntryFieldOption = string | {
  value: string
  label: string
}
...
export interface StructuredEntryField {
  ...
  options?: StructuredEntryFieldOption[]
  multiline?: boolean
  rows?: number
  maxWords?: number
}

export interface StructuredEntryVisualHotspot {
  id: string
  label: string
  shortLabel?: string
  description?: string
...
export interface StructuredEntryVisualBeat {
  label: string
  helper?: string
}
...
export interface StructuredEntryPreviousResponseReference {
  bindingKey: string
  title: string
  emptyText?: string
...
export interface PlaytestTimelineEvent {
  ...
  description: string
  image?: string
  layers?: PlaytestTimelineLayer[]
  focusX?: number
  focusY?: number
  fallbackLabel?: string
}

export interface PlaytestTimelineLayer {
  id: string
  image: string
  xPct: number
  yPct: number
...
export interface PlaytestTimelineObservationItem {
  id: string
  tester: string
  prompt: string
}

export interface PlaytestTimelineNode extends BaseNode {
  type: 'playtest_timeline'
  bindingKey: string
  stateBindingKey?: string
  priorityBindingKey?: string
  previousWatchlistKey?: string
  previousWatchlistTitle?: string
  emptyWatchlistText?: string
  prompt: string
  priorityPrompt?: string
  events: PlaytestTimelineEvent[]
  observationItems: PlaytestTimelineObservationItem[]
}
