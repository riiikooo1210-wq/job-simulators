...
import PhysicalPlaygroundScene from '../scenes/PhysicalPlaygroundScene'
import CameraShootScene from '../scenes/CameraShootScene'
import CommentQueueScene from '../scenes/CommentQueueScene'
import CampaignStudioScene from '../scenes/CampaignStudioScene'
...
import PlaytestTimelineScene from '../scenes/PlaytestTimelineScene'
...
const SCENE_MAP: Record<SceneType, React.ComponentType<{ node: any }>> = {
  ...
  action_simulation: PhysicalPlaygroundScene,
  physical_playground: PhysicalPlaygroundScene,
  camera_shoot: CameraShootScene,
  comment_queue: CommentQueueScene,
  campaign_studio: CampaignStudioScene,
  ...
  playtest_timeline: PlaytestTimelineScene,
}
