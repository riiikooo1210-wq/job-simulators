...
export interface VoiceMeetingNode extends BaseNode {
  ...
  /** Use in_person for colocated workplace conversations, voicemail for one-way recorded messages, or omit/remote for video or phone calls. */
  meetingMode?: 'in_person' | 'remote' | 'voicemail'
  /** Legacy alias used by older generated simulators; prefer meetingMode in new configs. */
  presentation?: 'in_person' | 'remote' | 'voicemail'
  meetingTitle?: string
  startLabel?: string
  endLabel?: string
  interactionLabel?: string
  inPersonImagePlacement?: 'banner' | 'inline'
  ...
  voicemailDraftKey?: string
  voicemailDraftTitle?: string
  voicemailDraftPrompt?: string
  voicemailDraftPlaceholder?: string
  sessionNotesKey?: string
  sessionNotesTitle?: string
  sessionNotesPrompt?: string
  sessionNotesPlaceholder?: string
  sessionNotesPlacement?: 'reference' | 'below_image'
  minTurns?: number
  maxTurns?: number
  voiceName?: string
  initialMessages?: ChatMessage[]
