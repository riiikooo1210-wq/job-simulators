...
const KIND_TO_DEVICE: Record<WorkSurfaceKind, WorkSurfaceDevice> = {
  ...
  architect_design_studio: 'desktop',
...
const TYPE_TO_KIND: Record<string, WorkSurfaceKind> = {
  ...
  architect_design_studio: 'architect_design_studio',
...
export default function WorkSurfaceFrame({
  ...
  if (resolvedDevice === 'laptop' || resolvedDevice === 'meeting') {
    return (
      <LaptopFrame
        variant={resolvedDevice === 'meeting' ? 'meeting' : resolvedVariant}
        title={resolvedTitle}
        fill={fill}
        scrollable={scrollable}
        titleTabs={titleTabs}
  ...
  return (
    <DesktopOverlay width={width} height={height} laptopZoom={desktopZoom} laptopOffsetX={desktopLaptopOffsetX} windowScale={desktopZoom}>
      <LaptopFrame
        variant={resolvedVariant}
        title={resolvedTitle}
        fill={fill}
