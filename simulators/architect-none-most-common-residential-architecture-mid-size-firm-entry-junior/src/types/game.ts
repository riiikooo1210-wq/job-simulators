...
export interface SourceRealismException {
  approvedByUser: true
  reason: string
...
export interface BaseNode {
  ...
  sourceRealismException?: SourceRealismException
}
...
export interface ArchitectDesignStudioNode extends BaseNode {
  type: 'architect_design_studio'
  prompt: string
  bindingKey: string
  toolModel?: string
  referenceTitle?: string
