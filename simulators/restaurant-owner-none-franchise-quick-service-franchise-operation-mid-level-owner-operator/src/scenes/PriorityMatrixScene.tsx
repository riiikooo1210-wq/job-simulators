            ...
            <DndContext sensors={sensors} onDragStart={handleDragStart} onDragEnd={handleDragEnd}>
              <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100%', padding: '0.75rem', gap: '0.75rem' }}>
                ...
                {unplacedItems.length > 0 && (
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.375rem', padding: '0.5rem 0.75rem', backgroundColor: '#F5F0FF', border: '1px solid #D4C8F0', borderRadius: '6px' }}>
                    <span style={{ fontSize: '0.65rem', fontWeight: 700, color: '#8B6FC7', width: '100%', marginBottom: '0.125rem' }}>DRAG ITEMS ONTO THE MATRIX</span>
                ...
                {/* Rationale + submit */}
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem', flex: '0 0 auto', paddingTop: '0.5rem', borderTop: '1px solid #D4C8F0', backgroundColor: '#F7F1E3' }}>
