...
import { STORE_PERSIST_KEY } from '../lib/persistKey'

// Persist key is set per-job at scaffold time via STORE_PERSIST_KEY.
...
const persistKey = STORE_PERSIST_KEY || 'job-simulator-storage'
