...
export default function LaptopFrame({ children, variant = 'doc', title, scrollable = false, fill = false, contentPadding, contentFlex = false }: LaptopFrameProps) {
    ...
    >
      ...
      <div
        style={{
          ...
          ...(contentFlex ? { display: 'flex', flexDirection: 'column' } : {}),
        }}
      >
        {children}
      </div>
