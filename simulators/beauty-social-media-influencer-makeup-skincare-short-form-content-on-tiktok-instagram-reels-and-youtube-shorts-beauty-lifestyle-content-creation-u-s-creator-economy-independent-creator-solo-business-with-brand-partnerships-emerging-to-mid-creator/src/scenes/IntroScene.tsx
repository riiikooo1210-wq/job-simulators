...
function IntroIllustration({ src }: { src: string }) {
  return (
    <div style={{ width: 'calc(100% + 6rem)', aspectRatio: '16 / 9', marginLeft: '-3rem', marginRight: '-3rem', overflow: 'hidden', borderTop: '1px solid #000', borderBottom: '1px solid #000', backgroundColor: '#E8DCC8' }}>
    ...
    return (
      <SceneWrapper illustration={node.illustration} hideIllustration>
        ...
        >
          ...
          {node.illustration && (
            <IntroIllustration src={node.illustration} />
          )}
