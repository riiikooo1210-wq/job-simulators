      ...
      >
        ...
        <DesktopOverlay>
          <div className={`voice-meeting-workspace${(prepReference || prepNote) ? '' : ' voice-meeting-workspace--solo'}`}>
            <div className="voice-meeting-window">
              <LaptopFrame variant="meeting" title={`Live meeting – ${npc.name}`} fill>
                <div style={{ display: 'flex', flexDirection: 'column', height: '100%', color: '#1E1E1A', padding: '0.875rem' }}>
            ...
            {(prepReference || prepNote) && (
              <div className="voice-meeting-reference">
