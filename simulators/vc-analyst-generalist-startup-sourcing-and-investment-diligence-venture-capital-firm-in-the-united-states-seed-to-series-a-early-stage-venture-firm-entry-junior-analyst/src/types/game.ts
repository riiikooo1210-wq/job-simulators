...
export interface KanbanBoardNode extends BaseNode {
  ...
  cards: KanbanCard[]
  bindingKey: string
  classificationMode?: 'drag_drop' | 'dropdown'
...
export interface MatrixSlackTab {
  id?: string
  label?: string
  windowTitle?: string
  bindingKey: string
  choiceBindingKey?: string
  choicePrompt?: string
  choicePlaceholder?: string
  choiceOptions?: MCOption[]
  reasonBindingKey?: string
  reasonLabel?: string
  prompt: string
  placeholder?: string
  minWords?: number
