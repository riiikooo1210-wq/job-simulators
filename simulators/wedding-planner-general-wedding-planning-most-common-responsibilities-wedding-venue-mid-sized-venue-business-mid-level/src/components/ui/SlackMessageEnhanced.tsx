...
function getMessageAvatarColor(message: SlackMessageData): string {
  return message.avatarColor || getAvatarColor(message.sender)
}
        ...
        >
          ...
          <div
            style={{
              ...
              height: '24px',
              borderRadius: '4px',
              backgroundColor: getMessageAvatarColor(message),
              display: 'flex',
              alignItems: 'center',
